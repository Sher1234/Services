...
public class StartVisit extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((AppCompatTextView) findViewById(R.id.textViewTitle)).setText(R.string.start_visit);
        taskV = TaskVisit.VisitStart(this, call, this);
    ...
    public void onFetched(Responded response, int i) {
        ...
        if (response != null) {
            ...
            if (response.Code == 1) taskV.onVisitStarted(this);
        } else {
            if (i == 306)
    ...
    public void fetch() {
        ...
        taskV.onStartVisit(this, taskV.getVisitStart(getLocationString()));
    }
}