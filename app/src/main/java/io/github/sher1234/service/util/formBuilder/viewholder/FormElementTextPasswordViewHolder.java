...
public class FormElementTextPasswordViewHolder extends BaseViewHolder {
    ...
    public FormElementTextPasswordViewHolder(View v, FormItemEditTextListener listener) {
        ...
        mEditTextValue.setInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
        mEditTextValue.setRawInputType(InputType.TYPE_CLASS_TEXT | InputType.TYPE_TEXT_VARIATION_PASSWORD);
    }
