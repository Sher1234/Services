...
public class EditVisit extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        taskV = TaskVisit.VisitEdit(this, visit, call, this);
    ...
    public void onValueChanged(FormElement formElement) {
        if (taskV.isEditFormValid()) fab.show();
        else fab.hide();
    }
    ...
    public void onFetched(Responded response, int i) {
        ...
        if (response != null) {
            ...
            if (response.Code == 1) taskV.onVisitEdited(this);
        } else {
            if (i == 306)
    ...
    @Override
    public void fetch() {
        taskV.onEditVisit(this, taskV.getEditVisit());
    }
}