package io.github.sher1234.service.ui.v1.b.fragment;
...
public class Pager extends Fragment implements RadioGroup.OnCheckedChangeListener {
    ...
    private void onUpdateView(List<Integer> integers, List<String> strings) {
        ...
        if (graphAdapter != null) graphAdapter.onGraphUpdate(integers, null);
        else {
            graphAdapter = GraphAdapter.newInstance(null);
